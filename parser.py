...
regex_Spell = [
        r'((?<=[^A-Za-z0-9])|^)([a-zA-Z-0-9./]+(=[a-zA-Z-0-9./ :]+)+(, )?)((?=[^A-Za-z0-9])|$)',#"ID"
        r'((?<=[^A-Za-z0-9])|^)((:*)([a-f0-9]{1,4}(\\.|:+)){3,5}[a-f0-9]{1,4})((?=[^A-Za-z0-9])|$)'#IP"
        r'((?<=[^A-Za-z0-9])|^)(\\w{8}-\\w{4}-\\w{4}-\\w{4}-\\w{12})((?=[^A-Za-z0-9])|$)',#"TKN"
        r'((?<=[^A-Za-z0-9])|^)(\\w+://[^/]+(/[^/\\[\\] ]+)+)((?=[^A-Za-z0-9])|$)',#"URL"
        r'((?<=[^A-Za-z0-9])|^)((: ?)([A-Za-z]+\\s(\\w+ ?)+))((?=[^A-Za-z0-9])|$)',#"SEQ"
        r'((?<=[^A-Za-z0-9])|^)((: ?)(\\S+@\\S+))((?=[^A-Za-z0-9])|$)',#"SEQ"
